...
class CandidateView @JvmOverloads constructor(
     ...
     */
    fun showCandidates(words: List<String>, shouldCapitalize: Boolean = false) {
    ...
    private inner class CandidateAdapter : RecyclerView.Adapter<CandidateViewHolder>() {
        ...
        fun updateCandidates(words: List<String>, shouldCapitalize: Boolean) {
            candidates = words
